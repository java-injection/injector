 ...
 * argomenti e uno con soli 'width' e 'height'.
 * Si crei un metodo pubblico 'area' che calcoli l'area del tavolo. 
 * Si crei un metodo changeName, che cambi il 'name', assicurandosi che se 
